...
;----------------------------------------------------------
dashed_hangman proc
    lea dx, dashed_hangman_0
    mov ah, 09h
    int 21h
    lea dx, dashed_hangman_1
    mov ah, 09h
    int 21h
...
Random proc
   ; Get the current time
    ...
    mov al, [seconds]
    aam                  ; Adjust AX after multiply (converts to BCD)
    add ax, 3030h        ; Convert to ASCII
    mov [seconds_str], ah
    mov [seconds_str + 1], al
